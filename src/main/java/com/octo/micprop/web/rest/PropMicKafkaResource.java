...
@RestController
@RequestMapping("/api/prop-mic-kafka")
public class PropMicKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PropMicKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PropMicKafkaResource(KafkaProperties kafkaProperties) {
